...
public class ProductController {
	 ...
	 * 		catNo=902
	 * 요청 내용
	 * 		쿼리스트림으로 전달한 카테고리번호에 속하는 상품 목록화면을 요청한다.
	 * 처리 내용
	 * 		쿼리스트림으로 전달한 카테고리번호에 해당하는 상품 목록 정보를 조회해서 Model객체에 저장하고,
	...
	@GetMapping("/detail")
	public String detatil(@RequestParam("no") int productNo, Model model) {
